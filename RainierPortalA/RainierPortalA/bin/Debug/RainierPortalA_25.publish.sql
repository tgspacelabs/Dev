...
GO
PRINT N'The following operation was generated from a refactoring log file 1d77addf-afd8-421f-967f-632268ae3fc5';

PRINT N'Rename [PHI].[Patient] to PatientDemographics';


GO
EXECUTE sp_rename @objname = N'[PHI].[Patient]', @newname = N'PatientDemographics', @objtype = N'OBJECT';


GO
-- Refactoring step to update target server with deployed transaction logs
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1d77addf-afd8-421f-967f-632268ae3fc5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1d77addf-afd8-421f-967f-632268ae3fc5')
