...
GO
PRINT N'Creating [PHI].[FK_Patient_Gender_GenderID]...';


GO
ALTER TABLE [PHI].[Patient] WITH NOCHECK
    ADD CONSTRAINT [FK_Patient_Gender_GenderID] FOREIGN KEY ([GenderID]) REFERENCES [dbo].[Gender] ([GenderID]);
...
GO
ALTER TABLE [PHI].[Patient] WITH CHECK CHECK CONSTRAINT [FK_Patient_Gender_GenderID];
