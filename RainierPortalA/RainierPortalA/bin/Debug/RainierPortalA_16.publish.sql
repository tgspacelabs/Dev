...
GO
PRINT N'Dropping [dbo].[PK6]...';


GO
ALTER TABLE [dbo].[ParameterValue] DROP CONSTRAINT [PK6];


GO
PRINT N'Creating [dbo].[PK_ParameterValue_ParameterValueID]...';


GO
ALTER TABLE [dbo].[ParameterValue]
    ADD CONSTRAINT [PK_ParameterValue_ParameterValueID] PRIMARY KEY NONCLUSTERED ([ParameterValueID] ASC) WITH (FILLFACTOR = 100);
