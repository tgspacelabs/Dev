...
GO
PRINT N'Dropping [dbo].[PK3]...';


GO
ALTER TABLE [dbo].[PatientDevice] DROP CONSTRAINT [PK3];


GO
PRINT N'Creating [dbo].[PK_PatientDevice_PatientDeviceID]...';


GO
ALTER TABLE [dbo].[PatientDevice]
    ADD CONSTRAINT [PK_PatientDevice_PatientDeviceID] PRIMARY KEY NONCLUSTERED ([PatientDeviceID] ASC) WITH (FILLFACTOR = 100);
