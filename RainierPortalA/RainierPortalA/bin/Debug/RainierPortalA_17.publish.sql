...
GO
PRINT N'Dropping [dbo].[DF_Parameter_CreatedDateTime]...';


GO
ALTER TABLE [dbo].[Parameter] DROP CONSTRAINT [DF_Parameter_CreatedDateTime];
...
GO
PRINT N'Dropping [dbo].[FK_ParameterValue_Parameter_ParameterID]...';


GO
ALTER TABLE [dbo].[ParameterValue] DROP CONSTRAINT [FK_ParameterValue_Parameter_ParameterID];


GO
PRINT N'Dropping [dbo].[FK_Parameter_ParameterType_ParameterTypeID]...';


GO
ALTER TABLE [dbo].[Parameter] DROP CONSTRAINT [FK_Parameter_ParameterType_ParameterTypeID];
...
CREATE TABLE [dbo].[tmp_ms_xx_Parameter] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Parameter_ParameterID1] PRIMARY KEY CLUSTERED ([ParameterID] ASC) WITH (FILLFACTOR = 100)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Parameter] ([ParameterID], [ParameterName], [ParameterTypeID], [CreatedDateTime])
        SELECT   [ParameterID],
                 [ParameterName],
                 [ParameterTypeID],
                 [CreatedDateTime]
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Parameter_ParameterID1]', N'PK_Parameter_ParameterID', N'OBJECT';
...
GO
PRINT N'Creating [dbo].[FK_ParameterValue_Parameter_ParameterID]...';


GO
ALTER TABLE [dbo].[ParameterValue] WITH NOCHECK
    ADD CONSTRAINT [FK_ParameterValue_Parameter_ParameterID] FOREIGN KEY ([ParameterID]) REFERENCES [dbo].[Parameter] ([ParameterID]);


GO
PRINT N'Creating [dbo].[FK_Parameter_ParameterType_ParameterTypeID]...';


GO
ALTER TABLE [dbo].[Parameter] WITH NOCHECK
    ADD CONSTRAINT [FK_Parameter_ParameterType_ParameterTypeID] FOREIGN KEY ([ParameterTypeID]) REFERENCES [dbo].[ParameterType] ([ParameterTypeID]);
...
ALTER TABLE [dbo].[ParameterValue] WITH CHECK CHECK CONSTRAINT [FK_ParameterValue_Parameter_ParameterID];

ALTER TABLE [dbo].[Parameter] WITH CHECK CHECK CONSTRAINT [FK_Parameter_ParameterType_ParameterTypeID];
