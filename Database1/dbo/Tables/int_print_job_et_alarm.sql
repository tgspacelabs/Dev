...
GO
CREATE NONCLUSTERED INDEX [IX_int_print_job_et_alarm_DeviceSessionId_AlarmStartTimeUTC_AlarmEndTimeUTC_PatientId]
    ON [dbo].[int_print_job_et_alarm]([DeviceSessionId] ASC, [AlarmStartTimeUTC] ASC, [AlarmEndTimeUTC] ASC)
