CREATE TABLE [dbo].[MetaData] (
    ...
    CONSTRAINT [PK_MetaData_Id] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 100)
);
...
GO
CREATE NONCLUSTERED INDEX [IX_MetaData_MetaDataId_NULL]
    ON [dbo].[MetaData]([MetaDataId] ASC)
    INCLUDE([Id], [Name], [Value], [IsLookUp], [TopicTypeId], [EntityName], [EntityMemberName], [DisplayOnly], [TypeId]) WHERE ([MetaDataId] IS NULL) WITH (FILLFACTOR = 100);
