...
GO
CREATE NONCLUSTERED INDEX [IX_cfgValuesPatient_timestamp_patient_id_type_cd_cfg_name]
    ON [dbo].[cfgValuesPatient]([timestamp] ASC)
    INCLUDE([patient_id], [type_cd], [cfg_name]) WITH (FILLFACTOR = 100);
