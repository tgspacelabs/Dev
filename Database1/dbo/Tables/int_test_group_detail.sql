...
GO
CREATE CLUSTERED INDEX [CL_test_group_detail_node_id_test_cid_univ_svc_cid_rank]
    ON [dbo].[int_test_group_detail]([node_id] ASC, [test_cid] ASC, [univ_svc_cid] ASC, [rank] ASC) WITH (FILLFACTOR = 100);


GO
CREATE NONCLUSTERED INDEX [IX_test_group_detail_node_id_alias_test_cid_alias_univ_svc_cid]
    ON [dbo].[int_test_group_detail]([node_id] ASC, [alias_test_cid] ASC, [alias_univ_svc_cid] ASC) WITH (FILLFACTOR = 100);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_test_group_detail_test_cid_univ_svc_cid_node_id_source_cid]
