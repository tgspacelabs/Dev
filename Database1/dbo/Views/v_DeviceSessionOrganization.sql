...
FROM
    ...
    LEFT OUTER JOIN [dbo].[int_organization] AS [Facilities] ON [Facilities].[organization_nm] = [FacilityName]
    LEFT OUTER JOIN [dbo].[int_organization] AS [Units] ON [Units].[organization_nm] = [UnitName]
