    ...
    WITH    [tree]
              AS (SELECT
                  ...
                  SELECT
                    ...
                    2 AS [orderby]
                  FROM
                    [dbo].[int_organization] [org1]
                    INNER JOIN [dbo].[int_organization] [facil] ON [org1].[organization_id] = [facil].[parent_organization_id]
                  ...
                  FROM
                    [dbo].[int_organization] [org1]
                    INNER JOIN [dbo].[int_organization] [facil2] ON [org1].[organization_id] = [facil2].[parent_organization_id]
