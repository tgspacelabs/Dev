...
{ 
    ...
    public class WaveformSSEController : WaveStreamControllerBase
    {
        ...
        /// <returns></returns>
        [Route("api/Devices/{deviceName}/Topics/{topicName}/Feeds/{feedName}/FeedWaveformSSE")]
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        [Route("api/Devices/{deviceId:guid}/Topics/{topicId:guid}/Feeds/{feedId:guid}/FeedWaveformSSE")]
