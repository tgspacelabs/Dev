...
GO
CREATE UNIQUE CLUSTERED INDEX [order_tbl_idx]
    ON [dbo].[int_order]([patient_id] ASC, [order_id] ASC, [encounter_id] ASC);


GO
CREATE NONCLUSTERED INDEX [order_tbl_ndx1]
    ON [dbo].[int_order]([parent_order_id] ASC);


GO
CREATE NONCLUSTERED INDEX [order_tbl_ndx2]
    ON [dbo].[int_order]([encounter_id] ASC);
