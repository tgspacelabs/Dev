...
CREATE UNIQUE CLUSTERED INDEX [external_organization_idx]
    ON [dbo].[int_external_organization]([ext_organization_id] ASC);


GO
CREATE NONCLUSTERED INDEX [external_organization_ndx1]
    ON [dbo].[int_external_organization]([organization_nm] ASC);


GO
CREATE NONCLUSTERED INDEX [external_organization_ndx2]
    ON [dbo].[int_external_organization]([company_cons] ASC);
