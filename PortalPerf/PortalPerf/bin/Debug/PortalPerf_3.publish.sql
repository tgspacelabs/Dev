...
CREATE TABLE [dbo].[tmp_ms_xx_Performance] (
    ...
    [ServerVersion]    VARCHAR (128)  CONSTRAINT [DF_Performance_ServerVersion] DEFAULT (@@VERSION) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Performance] ([PerformanceID], [ServerName], [ServerType], [Name], [BatchSize], [NumberOfBatches], [ElapsedTimeMs], [TotalRowsInTable], [Compressed])
