...
GO
PRINT N'Dropping [dbo].[DF_Performance_Created]...';


GO
ALTER TABLE [dbo].[Performance] DROP CONSTRAINT [DF_Performance_Created];
...
CREATE TABLE [dbo].[tmp_ms_xx_Performance] (
    ...
    [LogicalCPUCount]         INT            CONSTRAINT [DF_Performance_LogicalCPUCount] DEFAULT (0) NOT NULL,
    [SchedulerCount]          INT            CONSTRAINT [DF_Performance_SchedulerCount] DEFAULT (0) NOT NULL,
    [HyperthreadRatio]        INT            CONSTRAINT [DF_Performance_HyperthreadRatio] DEFAULT (0) NOT NULL,
    [PhysicalCPUCount]        INT            CONSTRAINT [DF_Performance_PhysicalCPUCount] DEFAULT (0) NOT NULL,
    [PhysicalMemoryKB]        INT            CONSTRAINT [DF_Performance_PhysicalMemoryKB] DEFAULT (0) NOT NULL,
    [CommittedMemoryKB]       INT            CONSTRAINT [DF_Performance_CommittedMemoryKB] DEFAULT (0) NOT NULL,
    [CommittedTargetMemoryKB] INT            CONSTRAINT [DF_Performance_CommittedTargetMemoryKB] DEFAULT (0) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Performance] ([PerformanceID], [ServerName], [ServerType], [ServerVersion], [Name], [BatchSize], [NumberOfBatches], [BytesPerRow], [ElapsedTimeMs], [TotalRowsInTable], [Compressed], [Created])
