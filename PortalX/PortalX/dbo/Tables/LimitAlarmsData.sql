...
GO
CREATE NONCLUSTERED INDEX [IX_LimitAlarmsData_TopicSessionId_AcquiredDateTimeUTC_includes]
    ON [dbo].[LimitAlarmsData]([TopicSessionId] ASC, [AcquiredDateTimeUTC] ASC)
    INCLUDE([AlarmId], [SettingViolated], [ViolatingValue], [StartDateTime], [PriorityWeightValue], [WaveformFeedTypeId], [IDEnumValue], [EnumGroupId], [EndDateTime]) WITH (FILLFACTOR = 100);
