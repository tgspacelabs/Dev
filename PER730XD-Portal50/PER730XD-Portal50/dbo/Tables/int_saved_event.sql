CREATE TABLE [dbo].[int_saved_event] (
    ...
    CONSTRAINT [PK_int_saved_event_Sequence] PRIMARY KEY CLUSTERED ([Sequence] ASC)
);


GO
CREATE NONCLUSTERED INDEX [ndx_saved_event]
    ON [dbo].[int_saved_event]([insert_dt] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_int_saved_event_patient_id_event_id_insert_dt_user_id]
    ON [dbo].[int_saved_event]([patient_id] ASC, [event_id] ASC, [insert_dt] ASC, [user_id] ASC);
