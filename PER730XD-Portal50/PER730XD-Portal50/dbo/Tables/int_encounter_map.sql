...
GO
CREATE UNIQUE CLUSTERED INDEX [enc_map_idx]
    ON [dbo].[int_encounter_map]([encounter_xid] ASC, [organization_id] ASC, [patient_id] ASC, [status_cd] ASC, [account_id] ASC, [seq_no] ASC);


GO
CREATE NONCLUSTERED INDEX [enc_map_ndx1]
    ON [dbo].[int_encounter_map]([encounter_id] ASC);


GO
CREATE NONCLUSTERED INDEX [enc_map_ndx2]
    ON [dbo].[int_encounter_map]([patient_id] ASC);
