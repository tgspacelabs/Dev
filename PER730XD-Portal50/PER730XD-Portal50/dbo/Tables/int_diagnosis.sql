...
GO
CREATE CLUSTERED INDEX [diagnosis_pkey]
    ON [dbo].[int_diagnosis]([encounter_id] ASC);
...
GO
EXECUTE sp_addextendedproperty @name = N'TestProperty', @value = N'This is a test property', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'int_diagnosis';
