...
CREATE NONCLUSTERED INDEX [IX_EventsData_TopicSessionId_TimeStampUTC_Subtype_Type_Value1_Value2_status_valid_leads_0]
    ...
    INCLUDE([Subtype], [Type], [Value1], [Value2], [status], [valid_leads]) WHERE ([CategoryValue]=(0)) WITH (FILLFACTOR = 100);


GO
CREATE NONCLUSTERED INDEX [IX_EventsData_TopicSessionId_TimeStampUTC_Subtype_Type_Value1_Value2_status_valid_leads_1]
    ON [dbo].[EventsData]([TopicSessionId] ASC, [TimeStampUTC] ASC)
    INCLUDE([Subtype], [Type], [Value1], [Value2], [status], [valid_leads]) WHERE ([CategoryValue]=(2) AND [Type]=(1)) WITH (FILLFACTOR = 100);
...
CREATE NONCLUSTERED INDEX [IX_EventsData_TopicSessionId_TimeStampUTC_Subtype_Type_Value1_Value2_status_valid_leads_2]
    ...
    INCLUDE([Value1], [Value2], [status], [valid_leads]) WHERE ([CategoryValue]=(2) AND ([Type] IN ((3), (4), (12)))) WITH (FILLFACTOR = 100);
...
GO
CREATE NONCLUSTERED INDEX [IX_EventsData_Type_Subtype_Value1_Value2_status_valid_leads_TimeStampUTC]
    ON [dbo].[EventsData]([Type] ASC, [Subtype] ASC, [Value1] ASC, [Value2] ASC, [status] ASC, [valid_leads] ASC, [TimeStampUTC] ASC) WITH (FILLFACTOR = 100);
