CREATE TABLE [dbo].[GeneralAlarmsData] (
    ...
    CONSTRAINT [PK_GeneralAlarmsData_Sequence] PRIMARY KEY CLUSTERED ([Sequence] ASC) WITH (FILLFACTOR = 100)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_GeneralAlarmsData_TopicSessionId_StartDateTime_EndDateTime_PriorityWeightValue_IDEnumValue]
