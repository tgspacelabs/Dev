CREATE TABLE [dbo].[int_account] (
    [account_id]         BIGINT NOT NULL CONSTRAINT [DF_int_account_account_id] DEFAULT (NEXT VALUE FOR [dbo].[SequenceBigInt]),
    ...
    CONSTRAINT [FK_int_account_int_organization_organization_id] FOREIGN KEY ([organization_id]) REFERENCES [dbo].[int_organization] ([organization_id])
);
