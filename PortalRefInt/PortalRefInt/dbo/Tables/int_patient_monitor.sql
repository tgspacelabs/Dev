CREATE TABLE [dbo].[int_patient_monitor] (
    ...
    CONSTRAINT [FK_int_patient_monitor_int_diagnosis_encounter_id] FOREIGN KEY ([encounter_id]) REFERENCES [dbo].[int_diagnosis] ([encounter_id]),
    CONSTRAINT [FK_int_patient_monitor_int_encounter_encounter_id] FOREIGN KEY ([encounter_id]) REFERENCES [dbo].[int_encounter] ([encounter_id]),
    CONSTRAINT [FK_int_patient_monitor_int_monitor_monitor_id] FOREIGN KEY ([monitor_id]) REFERENCES [dbo].[int_monitor] ([monitor_id]),
    CONSTRAINT [FK_int_patient_monitor_int_patient_patient_id] FOREIGN KEY ([patient_id]) REFERENCES [dbo].[int_patient] ([patient_id])
);
