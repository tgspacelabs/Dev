CREATE TABLE [dbo].[int_gateway] (
    ...
    CONSTRAINT [FK_int_gateway_int_organization_organization_id] FOREIGN KEY ([organization_id]) REFERENCES [dbo].[int_organization] ([organization_id])
);
