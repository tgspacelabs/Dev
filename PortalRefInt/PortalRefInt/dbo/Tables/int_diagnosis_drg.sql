CREATE TABLE [dbo].[int_diagnosis_drg] (
    ...
    CONSTRAINT [FK_int_diagnosis_drg_int_account_account_id] FOREIGN KEY ([account_id]) REFERENCES [dbo].[int_account] ([account_id]),
    CONSTRAINT [FK_int_diagnosis_drg_int_diagnosis_encounter_id] FOREIGN KEY ([encounter_id]) REFERENCES [dbo].[int_diagnosis] ([encounter_id]),
    CONSTRAINT [FK_int_diagnosis_drg_int_encounter_encounter_id] FOREIGN KEY ([encounter_id]) REFERENCES [dbo].[int_encounter] ([encounter_id])
);
