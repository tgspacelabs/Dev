CREATE TABLE [dbo].[int_encounter_map] (
    ...
    CONSTRAINT [FK_int_encounter_map_int_account_account_id] FOREIGN KEY ([account_id]) REFERENCES [dbo].[int_account] ([account_id]),
    CONSTRAINT [FK_int_encounter_map_int_diagnosis_encounter_id] FOREIGN KEY ([encounter_id]) REFERENCES [dbo].[int_diagnosis] ([encounter_id]),
    CONSTRAINT [FK_int_encounter_map_int_encounter_encounter_id] FOREIGN KEY ([encounter_id]) REFERENCES [dbo].[int_encounter] ([encounter_id]),
    CONSTRAINT [FK_int_encounter_map_int_organization_organization_id] FOREIGN KEY ([organization_id]) REFERENCES [dbo].[int_organization] ([organization_id]),
    CONSTRAINT [FK_int_encounter_map_int_patient_patient_id] FOREIGN KEY ([patient_id]) REFERENCES [dbo].[int_patient] ([patient_id])
);
