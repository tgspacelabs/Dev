CREATE TABLE [dbo].[int_misc_code] (
    ...
    CONSTRAINT [FK_int_misc_code_int_organization_organization_id] FOREIGN KEY ([organization_id]) REFERENCES [dbo].[int_organization] ([organization_id]),
    CONSTRAINT [FK_int_misc_code_int_send_sys_sys_id] FOREIGN KEY ([sys_id]) REFERENCES [dbo].[int_send_sys] ([sys_id])
);
