...
GO
CREATE UNIQUE CLUSTERED INDEX [ord_line_idx]
    ON [dbo].[int_order_line]([order_id] ASC, [univ_svc_cid] ASC, [patient_id] ASC, [seq_no] ASC);


GO
CREATE NONCLUSTERED INDEX [order_line_ndx1]
    ON [dbo].[int_order_line]([patient_id] ASC);
