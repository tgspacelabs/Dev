CREATE TABLE [dbo].[int_print_job_waveform] (
    ...
    CONSTRAINT [PK_int_print_job_waveform_row_dt_row_id] PRIMARY KEY CLUSTERED ([row_dt] ASC, [row_id] ASC)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_PrintJob_Waveforms]
    ON [dbo].[int_print_job_waveform]([print_job_id] ASC, [page_number] ASC, [seq_no] ASC, [module_num] ASC, [channel_num] ASC);
