...
CREATE UNIQUE CLUSTERED INDEX [patient_list_detail_idx]
    ON [dbo].[int_patient_list_detail]([patient_list_id] ASC, [patient_id] ASC, [encounter_id] ASC);


GO
CREATE NONCLUSTERED INDEX [patient_list_detail_ndx1]
    ON [dbo].[int_patient_list_detail]([patient_id] ASC);


GO
CREATE NONCLUSTERED INDEX [patient_list_detail_ndx2]
    ON [dbo].[int_patient_list_detail]([orig_patient_id] ASC);
