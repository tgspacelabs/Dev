...
CREATE UNIQUE CLUSTERED INDEX [ord_map_idx]
    ON [dbo].[int_order_map]([patient_id] ASC, [organization_id] ASC, [sys_id] ASC, [order_xid] ASC, [type_cd] ASC, [seq_no] ASC);


GO
CREATE NONCLUSTERED INDEX [ord_map_ndx1]
    ON [dbo].[int_order_map]([order_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ord_map_ndx2]
    ON [dbo].[int_order_map]([order_xid] ASC, [organization_id] ASC, [sys_id] ASC);
