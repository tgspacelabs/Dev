...
GO
CREATE CLUSTERED INDEX [test_group_detail_sort]
    ON [dbo].[int_test_group_detail]([node_id] ASC, [test_cid] ASC, [univ_svc_cid] ASC, [rank] ASC);


GO
CREATE NONCLUSTERED INDEX [test_group_detail_alias]
    ON [dbo].[int_test_group_detail]([node_id] ASC, [alias_test_cid] ASC, [alias_univ_svc_cid] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [test_group_detail_pk]
    ON [dbo].[int_test_group_detail]([test_cid] ASC, [univ_svc_cid] ASC, [node_id] ASC, [source_cid] ASC);
