CREATE TABLE [dbo].[int_beat_time_log] (
    ...
    CONSTRAINT [PK_int_beat_time_log_user_id_patient_id_sample_rate] PRIMARY KEY CLUSTERED ([user_id] ASC, [patient_id] ASC, [sample_rate] ASC),
    CONSTRAINT [AnalysisTime_int_beat_time_log] FOREIGN KEY ([user_id], [patient_id]) REFERENCES [dbo].[AnalysisTime] ([user_id], [patient_id]) ON DELETE CASCADE
);
