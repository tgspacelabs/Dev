...
GO
CREATE UNIQUE CLUSTERED INDEX [specimen_idx]
    ON [dbo].[int_specimen]([specimen_id] ASC, [patient_id] ASC);


GO
CREATE NONCLUSTERED INDEX [specimen_ndx1]
    ON [dbo].[int_specimen]([collect_id] ASC, [specimen_xid] ASC);


GO
CREATE NONCLUSTERED INDEX [specimen_ndx2]
    ON [dbo].[int_specimen]([patient_id] ASC, [encounter_id] ASC, [order_id] ASC);
