...
GO
CREATE CLUSTERED INDEX [CL_int_waveform_patient_id_patient_channel_id_start_ft_end_ft]
    ON [dbo].[int_waveform]([patient_id] ASC, [patient_channel_id] ASC, [start_ft] ASC, [end_ft] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_int_waveform_patient_channel_id_start_ft_end_ft]
    ON [dbo].[int_waveform]([patient_channel_id] ASC, [start_ft] ASC, [end_ft] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_int_waveform_end_ft]
    ON [dbo].[int_waveform]([end_dt] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_int_waveform_patient_id_start_ft_end_ft]
    ON [dbo].[int_waveform]([patient_id] ASC, [end_ft] ASC, [start_ft] ASC);
...
CREATE NONCLUSTERED INDEX [IX_int_waveform_patient_id_start_ft_patient_channel_id_start_dt_end_ft]
    ...
    INCLUDE([patient_channel_id], [start_dt], [end_ft]);
...
CREATE NONCLUSTERED INDEX [IX_int_waveform_patient_channel_id_patient_id_end_ft_start_ft_start_dt_end_dt_compress_method]
    ...
    INCLUDE([start_dt], [end_dt], [compress_method]);
