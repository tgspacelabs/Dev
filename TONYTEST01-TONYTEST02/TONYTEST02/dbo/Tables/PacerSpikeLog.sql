CREATE TABLE [dbo].[PacerSpikeLog] (
    ...
    CONSTRAINT [PK_PacerSpikeLog_user_id_patient_id_sample_rate] PRIMARY KEY CLUSTERED ([user_id] ASC, [patient_id] ASC, [sample_rate] ASC),
    CONSTRAINT [AnalysisTime_PacerSpikeLog] FOREIGN KEY ([user_id], [patient_id]) REFERENCES [dbo].[AnalysisTime] ([user_id], [patient_id]) ON DELETE CASCADE
);
