...
GO
CREATE UNIQUE CLUSTERED INDEX [patient_list_idx]
    ON [dbo].[int_patient_list]([patient_list_id] ASC);


GO
CREATE NONCLUSTERED INDEX [patient_list_ndx1]
    ON [dbo].[int_patient_list]([owner_id] ASC, [type_cd] ASC, [list_name] ASC);


GO
CREATE NONCLUSTERED INDEX [patient_list_ndx2]
    ON [dbo].[int_patient_list]([svc_cid] ASC);
