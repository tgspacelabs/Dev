...
GO
CREATE UNIQUE CLUSTERED INDEX [account_idx]
    ON [dbo].[int_account]([account_id] ASC);


GO
CREATE NONCLUSTERED INDEX [account_ndx1]
    ON [dbo].[int_account]([account_xid] ASC, [organization_id] ASC);
