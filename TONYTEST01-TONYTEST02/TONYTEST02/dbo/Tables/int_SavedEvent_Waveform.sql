CREATE TABLE [dbo].[int_SavedEvent_Waveform] (
    ...
    CONSTRAINT [PK_int_SavedEvent_Waveform_patient_id_event_id_channel_id] PRIMARY KEY CLUSTERED ([patient_id] ASC, [event_id] ASC, [channel_id] ASC),
...
GO
CREATE NONCLUSTERED INDEX [SavedEventWaveform_idx]
    ON [dbo].[int_SavedEvent_Waveform]([patient_id] ASC, [event_id] ASC);
