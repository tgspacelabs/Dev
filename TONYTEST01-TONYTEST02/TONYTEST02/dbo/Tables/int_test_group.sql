...
GO
CREATE UNIQUE CLUSTERED INDEX [test_group_pk]
    ON [dbo].[int_test_group]([node_id] ASC);


GO
CREATE NONCLUSTERED INDEX [test_group_parent_node]
    ON [dbo].[int_test_group]([parent_node_id] ASC, [node_name] ASC);


GO
CREATE NONCLUSTERED INDEX [test_group_rank]
    ON [dbo].[int_test_group]([rank] ASC);
