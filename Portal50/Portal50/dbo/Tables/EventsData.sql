CREATE TABLE [dbo].[EventsData] (
    ...
    CONSTRAINT [PK_EventsData_Id] PRIMARY KEY NONCLUSTERED ([Id] ASC)
);


GO
CREATE CLUSTERED INDEX [IX_EventsData_TopicSessionId_CategoryValue_TimeStampUTC_Type_Subtype]
