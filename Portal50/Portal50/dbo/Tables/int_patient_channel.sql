...
CREATE UNIQUE CLUSTERED INDEX [pkey_ndx]
    ON [dbo].[int_patient_channel]([patient_id] ASC, [monitor_id] ASC, [module_num] ASC, [channel_num] ASC, [patient_monitor_id] ASC, [channel_type_id] ASC);


GO
CREATE NONCLUSTERED INDEX [patient_channel_ndx2]
    ON [dbo].[int_patient_channel]([patient_monitor_id] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [patient_channel_ndx1]
    ON [dbo].[int_patient_channel]([patient_channel_id] ASC, [channel_type_id] ASC);
