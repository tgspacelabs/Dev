...
GO
CREATE UNIQUE CLUSTERED INDEX [hl7_out_queue_ndx]
    ON [dbo].[hl7_out_queue]([msg_no] ASC);


GO
CREATE NONCLUSTERED INDEX [hl7_out_queue_ndx1]
    ON [dbo].[hl7_out_queue]([queued_dt] ASC);


GO
CREATE NONCLUSTERED INDEX [hl7_out_queue_ndx2]
    ON [dbo].[hl7_out_queue]([sent_dt] ASC);


GO
CREATE NONCLUSTERED INDEX [hl7_out_queue_ndx3]
    ON [dbo].[hl7_out_queue]([patient_id] ASC);
