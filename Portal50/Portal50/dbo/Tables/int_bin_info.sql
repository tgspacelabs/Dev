CREATE TABLE [dbo].[int_bin_info] (
    ...
    CONSTRAINT [PK_int_bin_info_user_id_patient_id_template_set_index_template_index] PRIMARY KEY CLUSTERED ([user_id] ASC, [patient_id] ASC, [template_set_index] ASC, [template_index] ASC),
    CONSTRAINT [int_template_set_info_int_bin_info] FOREIGN KEY ([user_id], [patient_id], [template_set_index]) REFERENCES [dbo].[int_template_set_info] ([user_id], [patient_id], [template_set_index]) ON DELETE CASCADE
);
